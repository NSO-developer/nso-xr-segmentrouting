...
public class LoopServiceRFS {
    ...
    public Properties create(ServiceContext context,
        ...
        try {
            ...
            IPAddressAllocator.subnetRequest(service, poolName, "admin", 32, serviceName);
            ...
            try {
                ...
                if (IPAddressAllocator.responseReady(loop.context(), cdb, poolName, serviceName)) {
                    ConfIPPrefix net =
                        IPAddressAllocator.subnetRead(cdb, poolName, serviceName);

                    ConfIPPrefix from =
                        IPAddressAllocator.fromRead(cdb, poolName, serviceName);
